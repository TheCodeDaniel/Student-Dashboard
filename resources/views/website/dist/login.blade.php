            ...
            <div class="w-full col-span-5 mx-auto">
                ...
                <div class="w-[70%] mx-auto">
                    ...
                    <div class="register mt-20">
                        ...
                        <form action="{{ route('log') }}" method="post" class="mt-10 pb-10">
                            @csrf
                            <div class="results">
                    ...
                    <span>Don't have an account? <a class="text-sky-400" href="{{ route('reg_page') }}">create one</a></span>
